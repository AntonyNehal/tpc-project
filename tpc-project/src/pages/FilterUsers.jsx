...
//         />
//         {/* <button onClick={fetchUsers} className="bg-blue-500 text-white px-4 py-2 ml-2">Search</button> */}
//       </div>
...
//           <button onClick={() => setEditUser(null)} className="ml-2 px-4 py-2 bg-gray-500 text-white">Cancel</button>
//         </form>
//       )}
//     </div>
//   );
